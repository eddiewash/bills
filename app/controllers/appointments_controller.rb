class AppointmentsController < ApplicationController
  ...
  def index
    ...
    @scheduled_appointments = appointments.where("(invoices.invoice_date IS NULL or invoices.balance != ?) and invoices.appointment_date IS NOT NULL", 0).order("appointment_date ASC, appointment_time ASC")
